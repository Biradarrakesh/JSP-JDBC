...
<body>
 ...
 %> </font>
	...
	<div class="container">
		<div class="col">
			<div class="title">List of All Employees</div>
			<hr>
			<table border="border">
				<tr>
					<th>&emsp; ID &emsp;</th>
			...
			<br /> <span style="float: left; margin-right: 15px;">
				<form action="addEmplyoee.jsp">
					<input type="submit" value="ADD an Employee"
						class="btn btn-primary" />
				</form>
				<p>&emsp;</p>
			</span> <span style="float: left; margin-right: 15px;">
				<form action="updateEmployee.jsp">
					<input type="submit" value="UPDATE an Employee"
						class="btn btn-info" />
				</form>
